...
//	@Mock
	...
	private ThresholdsDistribution sut;
	...
	public void setup() throws IOException {
		...
		sut = new ThresholdsDistribution(rootFolder.getRoot(), parser, stats);
	...
	public void cannotBeInitializedWithNonExistingFolder() {
		...
		sut = new ThresholdsDistribution(new File("does not exist"), parser, stats);
	}
	...
	public void cannotBeInitializedWithFile() throws IOException {
		...
		sut = new ThresholdsDistribution(file, parser, stats);
	}
