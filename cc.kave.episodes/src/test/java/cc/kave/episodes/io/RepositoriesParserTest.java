...
//		Map<String, EventStreamGeneratorPrev> expReposGen = getRepoEvents();
//		Map<String, EventStreamGeneratorPrev> actReposGen = sut
//				.generateReposEvents();
//
...
//	}
//
//	private void assertRepos(Map<String, EventStreamGeneratorPrev> expReposGen,
//			Map<String, EventStreamGeneratorPrev> actReposGen) {
//
...
//			Map<String, EventStreamGeneratorPrev> repos) {
//
...
//	}
//
//	private Map<String, EventStreamGeneratorPrev> getRepoEvents() {
//		Map<String, EventStreamGeneratorPrev> reposEvents = Maps.newLinkedHashMap();
...
//
//		generator = new EventStreamGeneratorPrev();
