...
//	}
//
//	private Map<String, EventStreamGeneratorPrev> generateMapper() {
//
//		Map<String, EventStreamGeneratorPrev> mapper = Maps.newLinkedHashMap();
...
//	}
//
//	private EventStreamGeneratorPrev genCtx(int i) {
//
//		SST sst = new SST();
