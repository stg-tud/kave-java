...
//
//		Map<String, EventStreamGeneratorPrev> repos = reposParser
//				.generateReposEvents();
//
...
//			Map<String, EventStreamGeneratorPrev> in) {
//
//		List<Event> outs = Lists.newLinkedList();
//
//		int numRepos = 0;
//		int i = 0;
//		for (Map.Entry<String, EventStreamGeneratorPrev> entry : in.entrySet()) {
//			if (i != curFold) {
