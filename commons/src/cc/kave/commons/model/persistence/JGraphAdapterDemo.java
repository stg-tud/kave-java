...
public class JGraphAdapterDemo extends JApplet {
	...
	public void init() {
		...
		ListenableGraph<Fact, DefaultEdge> g = new ListenableDirectedMultigraph<Fact, DefaultEdge>(DefaultEdge.class);
	...
	private void positionVertexAt(Fact vertex, int x, int y) {
