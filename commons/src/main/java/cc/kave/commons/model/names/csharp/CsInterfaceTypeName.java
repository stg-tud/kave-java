...
public class CsInterfaceTypeName extends CsTypeName {

	protected CsInterfaceTypeName(String identifier) {
		super(identifier);
	}
	...
	static TypeName newCsInterfaceTypeName(String identifier) {
