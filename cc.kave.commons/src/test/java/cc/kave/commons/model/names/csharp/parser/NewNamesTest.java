...
public class NewNamesTest {
	...
	public void shouldImplementIsUnknown() {
		assertTrue(new CsTypeName("?").isUnknown());
	}

	@Test
	public void shouldGetNamespaceFromTypeInGlobalNamespace() {
		ITypeName name = new CsTypeName("MyType, Assembly, 1.2.3.4");
		assertEquals(NamespaceName.getGlobalNamespace(), name.getNamespace());
	}

	@Test
	public void shouldBeVoidType() {
		ITypeName name = new CsTypeName("System.Void, mscorlib, 4.0.0.0");
	...
	public void shouldNotBeVoidType() {
		for (String identifier : shouldNotBeVoidTypeCases()) {
			ITypeName name = new CsTypeName(identifier);
	...
	public void shouldBeSimpleType() {
		for (String identifer : shouldBeSimpleTypeCases()) {
			ITypeName name = new CsTypeName(identifer);
	...
	// {
	// TypeName name = Csnew CsTypeName(identifer);
	...
	public void shouldBeEnumType() {
		ITypeName name = new CsTypeName("e:My.EnumType, E, 3.9.5.6");
		assertTrue(name.isEnumType());
	}

	@Test
	public void shouldNotBeEnumType() {
		ITypeName name = new CsTypeName("Non.Enum.Type, E, 7.9.3.5");
	...
	private String[] shouldBeValueTypeCases() {
		return new String[] { "System.Int32, mscorlib, 4.0.0.0", "s:My.Struct, A, 1.0.0.0",
				...
				/*"T -> System.Boolean, mscorlib, 4.0.0.0"*/ }; // TODO: correct Name
	}
	...
	public void shouldNotBeInterfaceType() {
		ITypeName name = new CsTypeName("Some.Class, C, 3.2.1.0");
	...
	public void shouldNotBeUnknownType() {
		ITypeName name = new CsTypeName("Some.Known.Type, A, 1.2.3.4");
	...
	private String[] shouldBeClassTypeCases() {
		return new String[] { "System.Object, mscorlib, 4.0.0.0", "Some.Class, K, 0.9.8.7",
				/*"T -> Another.Class, F, 4.7.55.6" */}; // TODO: correct name
	}
	...
	private String[][] shouldDetermineFullNameCases() {
		return new String[][] { new String[] { "System.UInt16, mscorlib, 4.0.0.0", "System.UInt16" },
				...
				new String[] { "System.Nullable'1[[T->System.Int32, mscorlib, 4.0.0.0]], mscorlib, 4.0.0.0",
						"System.Nullable'1[[T->System.Int32, mscorlib, 4.0.0.0]]" },
	...
	private String[][] shouldDetermineNameCases() {
		return new String[][] { new String[] { "System.UInt16, mscorlib, 4.0.0.0", "UInt16" },
				...
				new String[] { "System.Nullable'1[[T->System.Int32, mscorlib, 4.0.0.0]], mscorlib, 4.0.0.0", "Nullable" },
				//new String[] { "T -> Some.Arbitrary.Type, Assembly, 5.6.4.7", "Type" },
				//new String[] { "Outer.Type+InnerType, As, 1.2.3.4", "InnerType" }, 
				new String[] { "?", "?" },
				new String[] { "Task'1[[TResult -> i:IList'1[[T -> T]], mscorlib, 4.0.0.0]], mscorlib, 4.0.0.0",
						"Task" } };
	}
	...
	private String[][] shouldDetermineNamespaceCases() {
		return new String[][] { new String[] { "System.UInt16, mscorlib, 4.0.0.0", "System" },
				...
				new String[] { "System.Nullable'1[[T->System.Int32, mscorlib, 4.0.0.0]], mscorlib, 4.0.0.0", "System" },
	...
	private String[][] shouldDetermineAssemblyCases() {
		return new String[][] { new String[] { "System.Object, mscorlib, 4.0.0.0", "mscorlib, 4.0.0.0" },
				...
				/*new String[] { "T -> Type.Parameter, A, 1.2.3.4", "A, 1.2.3.4" }//TODO: correct name*/ };
	}
	...
	public void shouldHaveTypeParameters() {
		...
		ITypeName parameterizedTypeName = new CsTypeName(
		...
		assertEquals(2, parameterizedTypeName.getTypeParameters().size()); // TODO: how to get this right?
	...
	public void shouldHaveUninstantiatedTypeParameters() {
		ITypeName typeName = new CsTypeName("OuterType'1+InnerType, Assembly, 1.2.3.4"); // TODO: ???
	...
	public void shouldBeTopLevelType() {
		ITypeName typeName = new CsTypeName("this.is.a.top.level.ValueType, " + TestAssemblyIdentifier);
	...
	private String[][] shouldBeNestedTypeCases() {
		return new String[][] { new String[] { "a.p.T+N", "a.p.T" }, new String[] { "N.O+M+I", "N.O+M" },
				new String[] { "n.T+A'1[[T1 -> e:n.T+B, P]]", "n.T" },
				/*new String[] { "n.T'1+U'1[[T2 -> T2]]", "n.T'1[[T2 -> T2]]" }*/ };  // TODO: ???
	}
	...
	public void shouldBeNestedType() {
		...
		for (int i = 0; i < cases.length; i++) {
			...
			ITypeName expected = expectedDeclaringTypeFullName.equals("?") ? TypeName.UNKNOWN_NAME
					: new CsTypeName(expectedDeclaringTypeFullName + ", " + TestAssemblyIdentifier);

			ITypeName nestedTypeName = new CsTypeName(nestedTypeFullName + ", " + TestAssemblyIdentifier);
	...
	public void shouldBeNestedParameterizedTypeInParameterizedType() {
		...
		ITypeName nestedTypeName = new CsTypeName("p.O'1+I'2[[" + p1Identifier + "],[" + p2Identifier + "],["
				+ p3Identifier + "]], " + TestAssemblyIdentifier); // TODO: ????
	...
	public void shouldBeParameterizedTypeWithParameterizedTypeParameter() {
		...
		final String paramIdentifier = "T2 -> on.PT'1[[" + paramParamIdentifier + "]], Y, 1.0.0.0";

		ITypeName typeName = new CsTypeName("n.OT'1[[" + paramIdentifier + "]], " + TestAssemblyIdentifier);
	...
	public void shouldNotHaveTypeParameterShortName() {
		ITypeName name = new CsTypeName("Non.Parameter.Type, As, 1.2.3.4");
	...
	public void shouldBeNotTypeParameter() {
		for (String identifier : shouldBeNotTypeParameterCases()) {
			ITypeName genericType = new CsTypeName(identifier);
