...
// (generated at: 8/13/2016 7:56:36 PM)
// ##############################################################################
/**
...
public class GeneratedTest {
	...
	public void TypeTest_21() {
		...
		assertNull(sut.getDeclaringType());
		assertTrue(sut.hasTypeParameters());
		assertEquals(Lists.newArrayList(new TypeParameterName("System.Int32, mscorlib, 1.2.3.4")),
				sut.getTypeParameters());
		boolean hasThrown;
		// array
		assertFalse(sut.isArray());
		hasThrown = false;
	...
	public void TypeTest_22() {
		...
		IArrayTypeName sutArr = sut.asArrayTypeName();
		assertEquals(1, sutArr.getRank());
		assertEquals(new TypeName("System.Nullable`1[[System.Int32, mscorlib, 1.2.3.4]], mscorlib, 1.2.3.4"),
				sutArr.getArrayBaseType());
		// delegates
		assertFalse(sut.isDelegateType());
		hasThrown = false;
		try {
	...
	public void TypeTest_39() {
		...
		assertNull(sut.getDeclaringType());
		assertTrue(sut.hasTypeParameters());
		assertEquals(Lists.newArrayList(new TypeParameterName("T -> d:[TR] [T2, P2].([T] arg)")),
				sut.getTypeParameters());
		boolean hasThrown;
		// array
		assertFalse(sut.isArray());
	...
	public void TypeTest_61() {
		...
		IArrayTypeName sutArr = sut.asArrayTypeName();
		assertEquals(1, sutArr.getRank());
		assertEquals(new TypeName("T1`1[][[T2 -> T3[],P]]+T4`1[][[T5 -> T6[],P]]+T7`1[[T8 -> T9[],P]], P"),
				sutArr.getArrayBaseType());
		// delegates
		assertFalse(sut.isDelegateType());
		hasThrown = false;
	...
	public void TypeTest_75() {
		...
		assertEquals(
				Lists.newArrayList(
						new ParameterName("[T`1[[T -> d:[?] [n.C+D, P].([T`1[[T -> n.C+D, P]], P] p)]], P] p")),
				sutD.getParameters());
		assertEquals(new TypeName("?"), sutD.getReturnType());
		// predefined
		assertFalse(sut.isPredefined());
	...
	public void TypeTest_135() {
		...
		assertNull(sut.getDeclaringType());
		assertTrue(sut.hasTypeParameters());
		assertEquals(Lists.newArrayList(new TypeParameterName("System.Int32, mscorlib, 4.0.0.0")),
				sut.getTypeParameters());
		boolean hasThrown;
		// array
		assertFalse(sut.isArray());
	...
	public void TypeTest_136() {
		...
		IArrayTypeName sutArr = sut.asArrayTypeName();
		assertEquals(1, sutArr.getRank());
		assertEquals(new TypeName("System.Nullable`1[[System.Int32, mscorlib, 4.0.0.0]], mscorlib, 4.0.0.0"),
				sutArr.getArrayBaseType());
		// delegates
		assertFalse(sut.isDelegateType());
		hasThrown = false;
	...
	public void TypeTest_141() {
		...
		assertNull(sut.getDeclaringType());
		assertTrue(sut.hasTypeParameters());
		assertEquals(Lists.newArrayList(new TypeParameterName("TResult -> i:IList`1[[T -> T]], mscorlib, 4.0.0.0")),
				sut.getTypeParameters());
		boolean hasThrown;
		// array
		assertFalse(sut.isArray());
	...
	public void TypeTest_142() {
		...
		IArrayTypeName sutArr = sut.asArrayTypeName();
		assertEquals(1, sutArr.getRank());
		assertEquals(new TypeName("Task`1[[TResult -> i:IList`1[[T -> T]], mscorlib, 4.0.0.0]], mscorlib, 4.0.0.0"),
				sutArr.getArrayBaseType());
		// delegates
		assertFalse(sut.isDelegateType());
		hasThrown = false;
	...
	public void TypeTest_147() {
		...
		assertTrue(sutD.hasParameters());
		assertFalse(sutD.isRecursive());
		assertEquals(Lists.newArrayList(new ParameterName("[?] p1"), new ParameterName("[?] p2")),
				sutD.getParameters());
		assertEquals(new TypeName("?"), sutD.getReturnType());
		// predefined
		assertFalse(sut.isPredefined());
	...
	public void TypeTest_156() {
		...
		assertTrue(sutD.hasParameters());
		assertTrue(sutD.isRecursive());
		assertEquals(Lists.newArrayList(new ParameterName("[d:[T] [T].([T] p1, [T] p2)] p1"),
				new ParameterName("[d:[T] [T].([T] p1, [T] p2)] p2")), sutD.getParameters());
	...
	public void TypeTest_162() {
		...
		assertTrue(sutD.hasParameters());
		assertTrue(sutD.isRecursive());
		assertEquals(Lists.newArrayList(new ParameterName("[d:[T -> T,P] [T -> T,P].([T -> T,P] p1)] p1")),
				sutD.getParameters());
	...
	public void TypeTest_165() {
		...
		assertTrue(sutD.isRecursive());
		assertEquals(
				Lists.newArrayList(new ParameterName("[d:[T -> T,P] [T -> T,P].([T -> T,P] p1, [T -> T,P] p2)] p1"),
						new ParameterName("[d:[T -> T,P] [T -> T,P].([T -> T,P] p1, [T -> T,P] p2)] p2")),
				sutD.getParameters());
		assertEquals(new DelegateTypeName("d:[T -> T,P] [T -> T,P].([T -> T,P] p1, [T -> T,P] p2)"),
				sutD.getReturnType());
		// predefined
		assertFalse(sut.isPredefined());
		hasThrown = false;
	...
	public void TypeTest_171() {
		...
		assertTrue(sutD.hasParameters());
		assertTrue(sutD.isRecursive());
		assertEquals(Lists.newArrayList(new ParameterName("[d:[T,P] [T,P].([T,P] p1, [T,P] p2)] p1"),
				new ParameterName("[d:[T,P] [T,P].([T,P] p1, [T,P] p2)] p2")), sutD.getParameters());
	...
	public void TypeTest_177() {
		...
		assertTrue(sutD.hasParameters());
		assertTrue(sutD.isRecursive());
		assertEquals(Lists.newArrayList(new ParameterName("[d:[T[],P] [T[],P].([T[],P] p1)] p1")),
				sutD.getParameters());
		assertEquals(new DelegateTypeName("d:[T[],P] [T[],P].([T[],P] p1)"), sutD.getReturnType());
		// predefined
		assertFalse(sut.isPredefined());
	...
	public void TypeTest_184() {
		...
		IArrayTypeName sutArr = sut.asArrayTypeName();
		assertEquals(1, sutArr.getRank());
		assertEquals(new DelegateTypeName("d:[d:[?] [n.C+D, P].()] [d:[?] [n.C+D, P].()].()"),
				sutArr.getArrayBaseType());
		// delegates
		assertFalse(sut.isDelegateType());
		hasThrown = false;
	...
	public void TypeTest_186() {
		...
		assertTrue(sutD.isRecursive());
		assertEquals(
				Lists.newArrayList(new ParameterName(
						"[d:[d:[?] [n.C+D, P].()] [d:[?] [n.C+D, P].()].([d:[?] [n.C+D, P].()] p1)] p1")),
				sutD.getParameters());
		assertEquals(new DelegateTypeName("d:[d:[?] [n.C+D, P].()] [d:[?] [n.C+D, P].()].([d:[?] [n.C+D, P].()] p1)"),
				sutD.getReturnType());
		// predefined
		assertFalse(sut.isPredefined());
		hasThrown = false;
	...
	public void TypeTest_189() {
		...
		assertEquals(
				Lists.newArrayList(
						new ParameterName(
								"[d:[d:[?] [n.C+D, P].()] [d:[?] [n.C+D, P].()].([d:[?] [n.C+D, P].()] p1, [d:[?] [n.C+D, P].()] p2)] p1"),
						new ParameterName(
								"[d:[d:[?] [n.C+D, P].()] [d:[?] [n.C+D, P].()].([d:[?] [n.C+D, P].()] p1, [d:[?] [n.C+D, P].()] p2)] p2")),
				sutD.getParameters());
		assertEquals(
				new DelegateTypeName(
						"d:[d:[?] [n.C+D, P].()] [d:[?] [n.C+D, P].()].([d:[?] [n.C+D, P].()] p1, [d:[?] [n.C+D, P].()] p2)"),
				sutD.getReturnType());
		// predefined
		assertFalse(sut.isPredefined());
		hasThrown = false;
	...
	public void TypeTest_195() {
		...
		assertEquals(
				Lists.newArrayList(new ParameterName(
						"[d:[T`1[[P -> T2,P]],P] [T`1[[P -> T2,P]],P].([T`1[[P -> T2,P]],P] p1)] p1")),
				sutD.getParameters());
		assertEquals(new DelegateTypeName("d:[T`1[[P -> T2,P]],P] [T`1[[P -> T2,P]],P].([T`1[[P -> T2,P]],P] p1)"),
				sutD.getReturnType());
		// predefined
		assertFalse(sut.isPredefined());
		hasThrown = false;
	...
	public void TypeTest_198() {
		...
		assertEquals(
				Lists.newArrayList(
						new ParameterName(
								"[d:[T`1[[P -> T2,P]],P] [T`1[[P -> T2,P]],P].([T`1[[P -> T2,P]],P] p1, [T`1[[P -> T2,P]],P] p2)] p1"),
						new ParameterName(
								"[d:[T`1[[P -> T2,P]],P] [T`1[[P -> T2,P]],P].([T`1[[P -> T2,P]],P] p1, [T`1[[P -> T2,P]],P] p2)] p2")),
				sutD.getParameters());
		assertEquals(
				new DelegateTypeName(
						"d:[T`1[[P -> T2,P]],P] [T`1[[P -> T2,P]],P].([T`1[[P -> T2,P]],P] p1, [T`1[[P -> T2,P]],P] p2)"),
				sutD.getReturnType());
		// predefined
		assertFalse(sut.isPredefined());
		hasThrown = false;
	...
	public void TypeTest_216() {
		...
		assertEquals(
				Lists.newArrayList(
						new ParameterName("[d:[T[] -> T,P] [T[] -> T,P].([T[] -> T,P] p1, [T[] -> T,P] p2)] p1"),
						new ParameterName("[d:[T[] -> T,P] [T[] -> T,P].([T[] -> T,P] p1, [T[] -> T,P] p2)] p2")),
				sutD.getParameters());
		assertEquals(new DelegateTypeName("d:[T[] -> T,P] [T[] -> T,P].([T[] -> T,P] p1, [T[] -> T,P] p2)"),
				sutD.getReturnType());
	...
	public void TypeTest_222() {
		...
		assertTrue(sutD.isRecursive());
		assertEquals(
				Lists.newArrayList(new ParameterName("[d:[d:[?] [?].()[]] [d:[?] [?].()[]].([d:[?] [?].()[]] p1)] p1")),
				sutD.getParameters());
		assertEquals(new DelegateTypeName("d:[d:[?] [?].()[]] [d:[?] [?].()[]].([d:[?] [?].()[]] p1)"),
				sutD.getReturnType());
		// predefined
		assertFalse(sut.isPredefined());
		hasThrown = false;
	...
	public void TypeTest_225() {
		...
		assertEquals(
				...
				sutD.getParameters());
		assertEquals(
				new DelegateTypeName("d:[d:[?] [?].()[]] [d:[?] [?].()[]].([d:[?] [?].()[]] p1, [d:[?] [?].()[]] p2)"),
				sutD.getReturnType());
		// predefined
		assertFalse(sut.isPredefined());
		hasThrown = false;
	...
	public void TypeTest_231() {
		...
		assertEquals(
				Lists.newArrayList(
						new ParameterName("[d:[n.C+D`1[[T]], P] [n.C+D`1[[T]], P].([n.C+D`1[[T]], P] p1)] p1")),
				sutD.getParameters());
		assertEquals(new DelegateTypeName("d:[n.C+D`1[[T]], P] [n.C+D`1[[T]], P].([n.C+D`1[[T]], P] p1)"),
				sutD.getReturnType());
		// predefined
		assertFalse(sut.isPredefined());
		hasThrown = false;
	...
	public void TypeTest_234() {
		...
		assertEquals(
				Lists.newArrayList(
						new ParameterName(
								"[d:[n.C+D`1[[T]], P] [n.C+D`1[[T]], P].([n.C+D`1[[T]], P] p1, [n.C+D`1[[T]], P] p2)] p1"),
						new ParameterName(
								"[d:[n.C+D`1[[T]], P] [n.C+D`1[[T]], P].([n.C+D`1[[T]], P] p1, [n.C+D`1[[T]], P] p2)] p2")),
				sutD.getParameters());
		assertEquals(
				new DelegateTypeName(
						"d:[n.C+D`1[[T]], P] [n.C+D`1[[T]], P].([n.C+D`1[[T]], P] p1, [n.C+D`1[[T]], P] p2)"),
				sutD.getReturnType());
		// predefined
		assertFalse(sut.isPredefined());
		hasThrown = false;
	...
	public void TypeTest_240() {
		...
		assertEquals(
				Lists.newArrayList(
						new ParameterName("[d:[n.C`1[[T]]+D, P] [n.C`1[[T]]+D, P].([n.C`1[[T]]+D, P] p1)] p1")),
				sutD.getParameters());
		assertEquals(new DelegateTypeName("d:[n.C`1[[T]]+D, P] [n.C`1[[T]]+D, P].([n.C`1[[T]]+D, P] p1)"),
				sutD.getReturnType());
		// predefined
		assertFalse(sut.isPredefined());
		hasThrown = false;
	...
	public void TypeTest_243() {
		...
		assertEquals(
				Lists.newArrayList(
						new ParameterName(
								"[d:[n.C`1[[T]]+D, P] [n.C`1[[T]]+D, P].([n.C`1[[T]]+D, P] p1, [n.C`1[[T]]+D, P] p2)] p1"),
						new ParameterName(
								"[d:[n.C`1[[T]]+D, P] [n.C`1[[T]]+D, P].([n.C`1[[T]]+D, P] p1, [n.C`1[[T]]+D, P] p2)] p2")),
				sutD.getParameters());
		assertEquals(
				new DelegateTypeName(
						"d:[n.C`1[[T]]+D, P] [n.C`1[[T]]+D, P].([n.C`1[[T]]+D, P] p1, [n.C`1[[T]]+D, P] p2)"),
				sutD.getReturnType());
		// predefined
		assertFalse(sut.isPredefined());
		hasThrown = false;
	...
	public void TypeTest_249() {
		...
		assertTrue(sutD.hasParameters());
		assertTrue(sutD.isRecursive());
		assertEquals(Lists.newArrayList(new ParameterName("[d:[p:int] [p:int].([p:int] p1)] p1")),
				sutD.getParameters());
	...
	public void TypeTest_252() {
		...
		assertTrue(sutD.hasParameters());
		assertTrue(sutD.isRecursive());
		assertEquals(Lists.newArrayList(new ParameterName("[d:[p:int] [p:int].([p:int] p1, [p:int] p2)] p1"),
				new ParameterName("[d:[p:int] [p:int].([p:int] p1, [p:int] p2)] p2")), sutD.getParameters());
