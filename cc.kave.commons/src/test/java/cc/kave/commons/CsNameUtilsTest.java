...
public class CsNameUtilsTest {
	...
	public void ParsesParametersWithParameterizedType() {
		List<ParameterName> parameterNames = CsNameUtils.getParameterNames("M([A`1[[B, P]], P] p)");
		assertEquals(CsParameterName.newParameterName("[A`1[[B, P]], P] p"), parameterNames.get(0));
	}

	@Test
	public void ParsesParametersWithDelegateType() {
		List<ParameterName> parameterNames = CsNameUtils.getParameterNames("M([[DR, P] [D, P].()] p)");
		assertEquals(CsParameterName.newParameterName("[[DR, P] [D, P].()] p"), parameterNames.get(0));
	}

	@Test
	public void ParsesMultipleParameters() {
		List<ParameterName> parameterNames = CsNameUtils.getParameterNames("M([T1,P] a, [T2,P] b)");
		assertEquals(2, parameterNames.size());
		assertEquals(CsParameterName.newParameterName("[T1,P] a"), parameterNames.get(0));
		assertEquals(CsParameterName.newParameterName("[T2,P] b"), parameterNames.get(1));
	}

	@Test
	public void ParsesUnknownNames() {
		List<ParameterName> parameterNames = CsNameUtils.getParameterNames("???");
	...
	public void ParsesEmptyParameters() {
		List<ParameterName> parameterNames = CsNameUtils.getParameterNames("M()");
		assertEquals(0, parameterNames.size());
	}
	...
	public void ParsesParametersWithModifiers() {
		List<ParameterName> parameterNames = CsNameUtils.getParameterNames("M(out [T,P] p, out [T,P] q)");
		assertEquals(2, parameterNames.size());
		assertEquals(CsParameterName.newParameterName("out [T,P] p"), parameterNames.get(0));
		assertEquals(CsParameterName.newParameterName("out [T,P] q"), parameterNames.get(1));
	}

	@Test

	public void ParsesParametersWithAdditionalWhitespace() {
		List<ParameterName> parameterNames = CsNameUtils.getParameterNames("M(  out [T,P] p   )");
